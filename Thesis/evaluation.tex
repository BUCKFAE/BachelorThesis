...
\todo{HerrGewitter predicts switches}
...
\todo{Other flaws of the bot to apparent to notice}
...
\todo{Add Glicko-1 rating}

\section{Investigating Replays}
\todo{Bot is good at switching / using most damaging move.}
\todo{Bot is not easy to defeat by humans (Joni / Markus)}
\todo{}
