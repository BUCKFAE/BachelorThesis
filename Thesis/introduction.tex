...
\todo{Fix Pikachu image, properly cite screenshots}
...
\todo{Rules for the game are introduced}
\todo{Work of other researchers will be presented}
\todo{An agent is developed that combines existing rule based agents with existing MiniMax agents}
\todo{Results are presented, evaluation challenges are described}
