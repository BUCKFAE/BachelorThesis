...
\end{equation}
Using this, we can also introduce a \textbf{value} for each of our Pokémon where a higher value implies a more important
...
\todo{Flaws: Does not take Hazards, status moves, etc. into account.}
