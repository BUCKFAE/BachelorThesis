...
\subsubsection{Status condition}
...
\subsubsection{Important items}
\label{sec:Important-items}
\todo{These are very important, explain them}
\todo{Leftovers}
\todo{Life Orb}
\todo{Heavy-Duty Boots}
\todo{Choice Items}
\todo{Assault Vest}
\todo{Focus Sash}
...
\todo{Builds from random battles}
\label{sec:builds-randbats}
\todo{Drapion very good example at randbats guide}